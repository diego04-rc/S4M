...
public class ECorriendoAireJugador : EstadoJugador
{
    // Guardamos el contexto actual y la fabrica a traves del constructor de
    // estado jugador
    public ECorriendoAireJugador(MaquinaDeEstadosJugador contextoActual,
    ...
    public override void EntrarEstado()
    {
        ...
        _contexto.EstadoHojaActual = MaquinaDeEstadosJugador.EstadoHoja.CorriendoAire;
    ...
    {
        // DEBUG //
        Debug.Log("Estado Hoja: Corriendo");
