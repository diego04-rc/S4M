...
public class ECorriendoCombateFijandoJugador : EstadoJugador
{
    // Guardamos el contexto actual y la fabrica a traves del constructor de
    // estado jugador
    public ECorriendoCombateFijandoJugador(MaquinaDeEstadosJugador contextoActual,
    ...
    public override void ComprobarCambioEstado()
    {
        ...
        { CambiarEstado(_fabrica.QuietoCombateFijando()); }
    ...
    public override void EntrarEstado()
    {
        ...
        _contexto.EstadoHojaActual = MaquinaDeEstadosJugador.EstadoHoja.CorriendoCombateFijando;
    ...
    {
        // DEBUG //
        Debug.Log("Estado Hoja: Corriendo Combate Fijando");
