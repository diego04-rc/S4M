...
public class ECorriendoJugador : EstadoJugador
{
    // Guardamos el contexto actual y la fabrica a traves del constructor de
    // estado jugador
    public ECorriendoJugador(MaquinaDeEstadosJugador contextoActual,
    ...
    public override void EntrarEstado()
    {
        ...
        _contexto.EstadoHojaActual = MaquinaDeEstadosJugador.EstadoHoja.Corriendo;
