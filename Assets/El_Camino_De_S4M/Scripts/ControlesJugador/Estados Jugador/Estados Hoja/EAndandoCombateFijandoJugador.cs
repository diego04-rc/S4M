...
public class EAndandoCombateFijandoJugador : EstadoJugador
{
    // Guardamos el contexto actual y la fabrica a traves del constructor de
    // estado jugador
    public EAndandoCombateFijandoJugador(MaquinaDeEstadosJugador contextoActual,
    ...
    public override void EntrarEstado()
    {
        ...
        _contexto.EstadoHojaActual = MaquinaDeEstadosJugador.EstadoHoja.AndandoCombateFijando;
    ...
    {
        // DEBUG //
        Debug.Log("Estado Hoja: Andando Combate Fijando");
