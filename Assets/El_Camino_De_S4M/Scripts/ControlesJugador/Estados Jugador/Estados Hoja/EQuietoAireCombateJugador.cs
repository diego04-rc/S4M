...
public class EQuietoAireCombateJugador : EstadoJugador
{
    // Guardamos el contexto actual y la fabrica a traves del constructor de
    // estado jugador
    public EQuietoAireCombateJugador(MaquinaDeEstadosJugador contextoActual,
    ...
    public override void EntrarEstado()
    {
        ...
        _contexto.EstadoHojaActual = MaquinaDeEstadosJugador.EstadoHoja.QuietoAireCombate;
    ...
    {
        // DEBUG //
        Debug.Log("Estado Hoja: Quieto Aire Combate");
